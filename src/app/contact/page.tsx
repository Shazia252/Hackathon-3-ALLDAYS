    ...
    <div className="mt-24 lg:mx-28 md:mx-32 mb-48">
      <div className="grid grid-cols-1 gap-24 md:grid-cols-2 lg:grid-cols-2 text-center md:text-start lg:text-start">
        <div className="col-span-1">
          <h1 className="font-bold text-3xl text-[#151875]">
            Information About us
          </h1>
          <p className="text-[#8A8FB9] text-[12px] mt-4 text-justify">
        ...
        <div className="col-span-1">
          <h1 className="font-bold text-3xl text-[#151875]">Contact Way</h1>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5">
            <div className="col-span-1 mt-10 flex">
              <div className="gap-6 lg:flex md:flex">
                ...
                <div className="text-[#8A8FB9] text-[12px] *:text-wrap">
            ...
            <div className="col-span-1 mt-10 flex">
              <div className="gap-6 lg:flex md:flex">
                ...
                <div className="text-[#8A8FB9] text-[12px]">
                  <p>Support Forum</p>
                  <p>For over 24hr</p>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 mt-24 gap-14 mx-3 md:mx-0 lg:mx-0">
        <div className="col-span-1">
          <div className="text-2xl font-bold py-16">
            <h1 className="mb-7 text-4xl text-[#151875] flex justify-center md:justify-start lg:justify-start">
              Get in Touch
            </h1>
            <p className="text-[#8A8FB9] text-[12px] text-justify font-normal mb-8">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mattis
            ...
            <form className="text-sm font-normal">
              <div className="lg:flex lg:justify-between gap-6">
                <div className="form-group mb-6 flex-1">
                  <input
                    type="text"
                    className="form-control py-4 px-2 border border-gray-300 rounded-md w-full"
                    id="con_name"
              ...
              <div className="form-group">
                <input type="button"
                  className="form-control py-3 px-3 border border-gray-300 rounded-md text-white bg-pink-600 w-full lg:w-40 hover:bg-pink-400 hover:cursor-pointer"
                  value={"Send Mail"} required />
              </div>
            </form>
          </div>
        </div>
        <div className="col-span-1">
          <div className="lg:size-[500px] md:size-[550px] flex">
          <Image src="/conpic.png" alt="Test Image" width={693} height={462} />
          </div>
        </div>
      </div>
    </div>
