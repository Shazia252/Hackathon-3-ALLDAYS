      ...
      <div className="lg:mx-60 md:mx-48 my-32">
        <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-72">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr>
                <th className="text-xl text-[#1D3178] pb-4 text-left">Product</th>
                <th className="text-xl text-[#1D3178] pb-4 text-left">Price</th>
                <th className="text-xl text-[#1D3178] pb-4 text-right">Quantity</th>
                <th className="text-xl text-[#1D3178] pb-4 text-center">Total</th>
              </tr>
            </thead>
            <tbody>
              {cartItems.map((item) => (
          ...
          <input
                  type="button"
                  className="form-control py-2 px-2 border border-gray-200 rounded-md text-white bg-pink-600 w-full lg:w-44 md:w-36 hover:bg-pink-400 cursor-pointer"
                  value="Update Cart"
                />
            {/* <input
                  type="button"
          ...
          <div className="py-12 bg-gray-100 rounded-sm px-8">
            <div className="flex justify-between text-[#1D3178] font-bold text-lg">
                <p>Subtotals:</p>
                <p>$219.00</p>
            </div>
            <div className="my-4">
          ...
          <div>
            <div>
          <h1 className="my-8 font-bold text-[#1D3178] text-center text-2xl">Calculate Shopping</h1>
          </div>
          ...
          <form className="text-sm font-normal py-12 bg-gray-100 rounded-sm px-8">
              ...
              <div className="form-group">
                <input
                  type="button"
                  className="form-control py-3 px-3 border border-gray-200 rounded-md text-white bg-pink-600 w-full lg:w-44 md:w-36 hover:bg-pink-400 cursor-pointer"
